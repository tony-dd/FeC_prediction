...
model_without_last_3layers = MEGNetModel(100, 2, nblocks=3, nvocal=95, embedding_dim=16, graph_converter=gc)

model_energy = MEGNetModel.from_file('/data2/deh/model/FeC_megnet_model_shuffle_epoch1000_batch256_patience10.hdf5')

for index, layer in enumerate(model_without_last_3layers.layers):
    weights_trained_model = model_energy.layers[index].get_weights()
